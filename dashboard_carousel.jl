...
# ╔═╡ d3310169-4046-4292-8ee3-39417ab869e2
using PlutoUI

# ╔═╡ f34655c8-8ca5-44be-815d-3f704393098a
using HTMLStrings

# ╔═╡ 9ce997ec-fbaa-4fd2-9a94-31cd795d6814
using HTTP

# ╔═╡ eac6e9e5-26a8-4179-b324-3240c0770370
using DataFrames: DataFrame, dropmissing

# ╔═╡ a53c290f-143b-41c8-9f80-815288f4baa2
using CSV: File

# ╔═╡ 1630e655-a1a9-4ace-96c7-599992896525
using CairoMakie: Figure, Axis, barplot!, lines!, scatter!

# ╔═╡ 4bda9a0c-28ee-403c-baab-e35f8cdc28a5
using Dates: Date, week, Day, value, format

# ╔═╡ 78d0b0de-47c2-48d6-8b18-eaafc9a30f7a
TableOfContents()

# ╔═╡ d3e81a97-9f3f-40c7-97f8-bbaaf4df9249
url = "https://covid.ourworldindata.org/data/owid-covid-data.csv"

# ╔═╡ 1c1056e2-b0b5-4e78-a75a-0c014f367025
data = String(HTTP.get(url).body)

# ╔═╡ 2f7eb7df-ba6f-49e3-b829-8d0ef786bde9
df = File(IOBuffer(data)) |> DataFrame

# ╔═╡ 7c9e1722-c7e2-440c-bf83-f87ac93564ce
begin
	usa_data = filter(row -> row.location == "United States", df)
	usa_data = dropmissing(usa_data[:, 3:10])
end

# ╔═╡ 0d745a56-a27c-4d02-9f74-56c4811712e4
...
# ╔═╡ 41a1a229-f2ef-4064-ae82-82c7c0d53e2d
...
# ╔═╡ 7736b8c9-81af-4715-85de-bcbb13061712
carousel_css = """
.carousel {
	position: relative;
	width: 100%;
...
# ╔═╡ cfdbd794-7b44-409a-8518-099e8598f607
...
# ╔═╡ 1dc280b4-1052-49c7-aaa2-85bb3ea42454
md"""
Select the column: $(@bind selected_column Select(["total_cases", "new_cases", "new_deaths"], default = "total_cases"))
"""

# ╔═╡ e814122b-1820-4ff9-a651-a76799194e8f
bar_plot = create_bar_plot(usa_data, selected_column);

# ╔═╡ 9001883c-5f48-4f73-be35-6a563dbabcfb
md"""
...
# ╔═╡ 0fccd2f8-3d32-420d-817a-b882eb1a2918
line_plot = create_line_plot(usa_data, date_range_low, date_range_high);

# ╔═╡ 720a6857-3a0b-4f80-9266-c97ff81c0800
to_html(
	divv(
		h2("Interactive Charts"),
		divv(:id => "charts-carousel", :class => "carousel",
			divv(:class => "carousel-item active",
				repr(MIME"text/html"(), bar_plot)
			),
			divv(:class => "carousel-item",
				repr(MIME"text/html"(), line_plot)
			),
			a(:class => "carousel-control prev", :href => "#", "&#10094;"),
			a(:class => "carousel-control next", :href => "#", "&#10095;")
		),
		style(carousel_css),
		script(carousel_script("charts-carousel"))
	)
)
...
manifest_format = "2.0"
project_hash = "8a2a5c39c7f1b768893a7d827292cf61069c8015"
